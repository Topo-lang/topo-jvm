...
//     numerically wrong.
//   - COVERED → OPT after `config-pipeline-section-not-in-knownsections`
//     was fixed; honest measurement showed friendly forced/base ≈ 0.667.
...
public class PipelinePass implements BasePass {
    ...
    private static final class BridgeSpec {
         ...
         * the generated bytecode will throw at runtime — tracked in the
         * resolution of this pass's proposal.
         */
